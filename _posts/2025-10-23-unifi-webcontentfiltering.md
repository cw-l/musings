...
![NextDNS Setup](/assets/img/nextdns-profile.png){: width="auto" height="auto"}
...
![NextDNS Parental Control](/assets/img/nextdns-parentalcontrols.png){: width="15%" height="auto"}
...
![UniFi Custom DNS Configuration](/assets/img/unifi-network-dns.png){: width="25%" height="auto"}
